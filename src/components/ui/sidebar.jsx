  ...
  ({ className, ...props }, ref) => {
    ...
    return (
      <button
        ...
        className={cn(
          "absolute inset-y-0 z-20 hidden w-4 -translate-x-1/2 transition-all ease-linear afterafter-y-0 after-1/2 after-[2px] group-data-[side=left]:-right-4 group-data-[side=right]-0 hover-sidebar-border sm",
